{
    // No se porqué pero es sospechosamente parecido a otro código...
    let canvas;
    ...
    function init() {
        ...
        // Para desactivar el menú contextual
        document.getElementById('auxclick').addEventListener('contextmenu', (e) => {
            e.preventDefault()
        });
